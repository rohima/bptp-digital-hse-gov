...
router.post('/placeholder-example', function (req, res) {  
  let findSearch = req.session.data.findSearch;
  res.redirect('placeholder-change-stated');
})

// placeholder-change-stated

router.post('/placeholder-change-stated', function (req, res) {  
  let findSearch = req.session.data.findSearch;
...
router.post('/active-substance-source-csv-1', function (req, res) {
  res.redirect('placeholder-existing-eamus');
})
...
// ----------------- PLACEHOLDER EXISTING EAMUS ----------------- //


// placeholder-existing-eamus

router.post('/placeholder-existing-eamus', function (req, res) {  
...
router.post('/documents-reference-product-risk-areas', function (req, res) {  
  let documentsReferenceProductRiskAreas = req.session.data.documentsReferenceProductRiskAreas;
  res.redirect('placeholder-registration-reports');
})
...
// include registration reports for the relevant areas

router.post('/placeholder-registration-reports', function (req, res) {  
  let placeholderPage = req.session.data.placeholderPage;
  res.redirect('placeholder-specialist-assessment');
})


// "What areas of the specialist assessment are required to support this use?"

router.post('/placeholder-specialist-assessment', function (req, res) {  
  let placeholderPage = req.session.data.placeholderPage;
  res.redirect('placeholder-application-overview');
})


// Application overview document upload

router.post('/placeholder-application-overview', function (req, res) {  
  let placeholderPage = req.session.data.placeholderPage;
