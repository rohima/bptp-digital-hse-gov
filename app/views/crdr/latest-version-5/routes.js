...
router.post('/request-delay-type', function (req, res) {
  ...
  if (requestDelayType == "Category 4 delay") {
    res.redirect('request-delay-type-cat4');
  } else {
    res.redirect('request-delay-who');
  }
...
// request-delay-type-cat4 XXXXXXXXX NEEDS ROUTING XXXXXXX

router.post('/request-delay-type', function (req, res) {

let requestDelayTypeCat4 = req.session.data.requestDelayType;
if (requestDelayTypeCat4 == "Category 4 delay") {
  res.redirect('request-delay-type-cat4');
} else {
  res.redirect('request-delay-who');
}
